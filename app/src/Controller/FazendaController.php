...
final class FazendaController extends AbstractController
{
    ...
    public function index(
        ...
        $qb = $fazendaRepository->createQueryBuilder('f')
            ->select('f')
            ->orderBy('f.id', 'DESC');
    ...
    public function resumo(
        ...
        return $this->render('fazenda/resumo.html.twig', [
            'nomes' => json_encode($nomes),
            'quantidadeAnimais' => json_encode($quantidadeAnimais),
            'producaoLeite' => json_encode($producaoLeite),
            'consumoRacao' => json_encode($consumoRacao),
        ]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_fazenda_index');
        }
    ...
    public function delete(Request $request, Fazenda $fazenda, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$fazenda->getId(), $request->request->get('_token'))) {
            ...
            $this->addFlash('danger', 'Fazenda removida com sucesso.');
        }
